...
# AI Personal Assistant M-One — Version 1.0 — Interface Typing
...
while True:
    ...
    if 'who are you' in query:
        print('I am M-One your persoanl assistant. I am programmed to minor tasks like'
              ' Opening Google, Predict Time and...')
        speak('I am M-One your persoanl assistant. I am programmed to minor tasks like'
              ' Opening Google, Predict Time and...')
        continue
